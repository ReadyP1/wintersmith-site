(function() {
  var async, build, chalk, commonOptions, commonUsage, extend, fileExistsSync, fs, loadEnv, logger, options, path, ref, ref1, rimraf, usage;
  ...
  ref = require('./../core/utils'), extend = ref.extend, fileExistsSync = ref.fileExistsSync;

  ref1 = require('./common'), loadEnv = ref1.loadEnv, commonOptions = ref1.commonOptions, commonUsage = ref1.commonUsage;
  ...
  build = function(argv) {
    ...
    return async.waterfall([
      ...
      if (error) {
        ...
        stop = new Date();
        delta = stop - start;
        return logger.info("done in " + (chalk.bold(delta)) + " ms\n");
      }
    });
  };
