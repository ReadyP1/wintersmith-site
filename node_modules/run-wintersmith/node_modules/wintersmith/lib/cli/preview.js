(function() {
  var Config, async, commonOptions, commonUsage, extend, loadEnv, logger, options, preview, ref, usage, util;
  ...
  ref = require('./common'), loadEnv = ref.loadEnv, commonUsage = ref.commonUsage, commonOptions = ref.commonOptions;
